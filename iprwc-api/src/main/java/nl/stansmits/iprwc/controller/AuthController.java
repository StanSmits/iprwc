...
public class AuthController {
    ...
    public Map<String, String> register(@RequestBody RegisterDTO registerDTO) {
        User user = authorizationService.convertToUserEntity(registerDTO);

        // Check if email is of a valid type
        if (!StringUtil.isValidEmail(registerDTO.getEmail())) {
